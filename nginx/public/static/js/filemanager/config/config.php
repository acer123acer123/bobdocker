...
$upload_dir = '/static/media/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../media/source/'; // relative path from filemanager folder to upload folder (with final /)
